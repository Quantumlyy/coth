 ...
 *
 * Bit `i` set means byte value `i` is plausible. 32 bytes × 8 bits
 * covers all 256 byte values; each row of 8 elements spans 64 byte
 * values (8 bytes × 8 bits per byte).
 */
static const uint8_t k_plausible_first_bytes[32] = {
	...
	/* 0xC0-0xFF */ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};
